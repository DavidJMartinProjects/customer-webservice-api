...
INSERT INTO customers (first_name, last_name, address, city, country, email, image) VALUES
  ...
  ('Mary', 'Bloggs', 'Town Square', 'London', 'UK', 'mb@email.com', 'https://bootdey.com/img/Content/avatar/avatar.png'),
  ...
  ('Mary', 'Bloggs', 'Town Square', 'London', 'UK', 'mb@email.com', 'https://bootdey.com/img/Content/avatar/avatar9.png'),
